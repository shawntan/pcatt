...
#
# Changes: add GreedTok as another option
""" Auto Model class. """
...
from ..hf.greedtok import GreedTok
...
class AutoTokenizer(object):
    ...
    in the `pretrained_model_name_or_path` string (in the following order):
        - contains `greedtok`: GreedTok (GreedTok Tokenizer model)
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        """
        if "greedtok" in pretrained_model_name_or_path:
            return GreedTok.from_pretrained(
        ...
        raise ValueError(
            ...
            "'greedtok', 'bert', 'openai-gpt', 'gpt2', 'transfo-xl', 'xlnet', "
